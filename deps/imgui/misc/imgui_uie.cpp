...
namespace ImGui
{
	...
	void StyleUIE()
	{
		...
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.94f, 0.94f, 0.94f, 0.78f);
		colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.49f, 0.49f, 0.49f, 0.67f);
		colors[ImGuiCol_ResizeGripActive] = ImVec4(0.31f, 0.31f, 0.33f, 0.95f);
		colors[ImGuiCol_Tab] = ImVec4(0.16f, 0.16f, 0.16f, 0.86f);
		colors[ImGuiCol_TabHovered] = ImVec4(0.56f, 0.56f, 0.56f, 0.80f);
		colors[ImGuiCol_TabActive] = ImVec4(0.38f, 0.38f, 0.38f, 1.00f);
		colors[ImGuiCol_TabUnfocused] = ImVec4(0.11f, 0.12f, 0.11f, 0.97f);
		colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.23f, 0.23f, 0.23f, 1.00f);
		colors[ImGuiCol_DockingPreview] = ImVec4(0.60f, 0.67f, 0.77f, 0.70f);
		colors[ImGuiCol_TextSelectedBg] = ImVec4(0.96f, 0.97f, 1.00f, 0.35f);
		colors[ImGuiCol_ModalWindowDimBg] = ImVec4(0.18f, 0.18f, 0.18f, 0.55f);
	}
